...
J. Tabacek and V. Havlena, "Reduction of stochastic prediction error sensitivity to parameters in Kalman filter," Journal of Franklin Institute, submitted revision, Oct. 2021
...
2. SESUP.mlappinstall    	 - MATLAB app installer for MATLAB (R2021a and later)
...
1. Standalone application for Windows/Linux
	...
	- LINUX (Tested in Ubuntu 20.04) 
		- install app by running "SesupInstallerWeb.install" and follow the instructions (don't forget to configure environment variables)
		- SESUP application will be installed together with MATLAB Runtime		 
		- start the app by locating and running "run_SESUP.sh"		

2. MATLAB App
	- install the app directly to your MATLAB (R2021a or later) or to MATLAB Online
...
1. Standalone application for Windows/Linux (limited functionality)
	A. Tested in Windows 10 / Ubuntu 20.04
...
2. MATLAB App 
	A. Tested in MATLAB R2021a. There are regular behavior changes in released MATLAB App Designer, therefore, the app might not work in newer versions.
